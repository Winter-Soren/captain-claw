...
function attack(self)
	...
	if not self.startTime then
		...
		claw.State = -1
		TextOut("First!")
		self.obj600 = CreateObject {x=9830, y=6534, z=2000, logic="TogglePeg", image="LEVEL_PEG"}
		self.obj601 = CreateObject {x=9440, y=6534, z=2000, logic="TogglePeg4", image="LEVEL_PEG"}
	end
end
