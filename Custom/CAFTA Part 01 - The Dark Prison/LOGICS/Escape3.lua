...
function attack(self)
	...
	if not self.startTime then
		...
		claw.State = -1
		TextOut("Third!")
		self.obj604 = CreateObject {x=9570, y=6534, z=2000, logic="TogglePeg3", image="LEVEL_PEG"}
		self.obj605 = CreateObject {x=9180, y=6534, z=2000, logic="TogglePeg2", image="LEVEL_PEG"}
	end
end
